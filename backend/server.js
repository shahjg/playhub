...
function initSpyfallGame(room, locationPack = 'classic', twoSpies = false) {
  ...
  const locationPacks = {
    ...
    horror: [
      ...
      { name: 'Summer Camp Crystal Lake', roles: ['Camp Counselor', 'Head Counselor', 'Camper', 'Camp Cook', 'Lifeguard', 'Final Girl', 'Jock', 'Stoner', 'Virgin', 'Sheriff', 'Masked Killer', 'Lone Survivor', 'Camp Nurse', 'Kayak Instructor'] },
      ...
      { name: 'The Shining Hedge Maze', roles: ['Psychic Child', 'Axe-Wielding Father', 'Terrified Mother', 'Hotel Ghost', 'Maze Groundskeeper', 'Frozen Victim', 'Snow Cat Rescuer', 'Bartender Ghost', 'Woman in Bathtub', 'Twin Ghosts', 'Hedge Trimmer', 'Lost Tourist', 'Winter Caretaker', 'Previous Victim', 'Typewriter Ghost'] }
    ],
